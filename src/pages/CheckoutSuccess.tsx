...
export default function CheckoutSuccessPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-12" style={{ background: "var(--neutral-50)" }}>
      <div
          ...
          <>
            <div className="flex justify-center mb-4">
              <div className="w-16 h-16 rounded-full bg-[color:var(--accent-50)] flex items-center justify-center">
                <CheckCircle2 size={36} className="text-[color:var(--accent-700)]" />
              </div>
            </div>
