...
export default function Verify2FAPage() {
  ...
  return (
    <div className="h-screen overflow-hidden flex items-center justify-center px-4" style={{ background: "var(--fundo-entrada)" }}>
      <div className="relative w-full max-w-[380px] rounded-[8px] p-[1px] overflow-hidden">
        {/* Rotating border lights */}
        <div
          className="absolute inset-[-100%]"
          style={{
            background: "var(--luz-cartao-feixe-a)",
        ...
        <div
          className="absolute inset-[-100%]"
          style={{
            background: "var(--luz-cartao-feixe-b)",
            animation: "spin-border var(--luz-cartao-giro) linear infinite",
          }}
        />
