              ...
              return (
                <div key={g.name}>
                  <button
                    ...
                    style={{ fontFamily: "Inter, sans-serif", fontVariationSettings: "'opsz' 14" }}
                  >
                      ...
                      {g.items.map(item => {
                        ...
                        return (
                          <button
                            ...
                            style={{ fontFamily: "Inter, sans-serif", fontSize: "13px", fontStyle: "normal", fontWeight: 400, letterSpacing: 0, fontVariationSettings: "'opsz' 20", color: "#09090b" }}
                          >
