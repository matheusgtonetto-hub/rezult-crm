...
/**
 * Âncora: diz ONDE o painel se posiciona, quando esse lugar não é o botão que
 * o abre. A barra lateral usa isso -- os botões redondos ficam dentro dela, e
 * um painel ancorado no botão abriria por cima da própria barra.
 */
