...
const pt = {
  ...
  "login.criarConta": "Criar uma conta",
  ...
  "cadastro.aceitoTermos": "Li e concordo com os",
  "cadastro.termos": "Termos de Serviço",
  "cadastro.aceitoPolitica": "Li e concordo com a",
  ...
  "cadastro.erroTermos": "Você precisa aceitar os Termos de Serviço.",
  "cadastro.erroPolitica": "Você precisa aceitar a Política de Privacidade.",
...
const en: Record<Chave, string> = {
  ...
  "login.criarConta": "Create an account",
  ...
  "cadastro.aceitoTermos": "I have read and agree to the",
  "cadastro.termos": "Terms of Service",
  "cadastro.aceitoPolitica": "I have read and agree to the",
  ...
  "cadastro.erroTermos": "You must accept the Terms of Service.",
  "cadastro.erroPolitica": "You must accept the Privacy Policy.",
...
const es: Record<Chave, string> = {
  ...
  "login.criarConta": "Crear una cuenta",
  ...
  "cadastro.aceitoTermos": "He leído y acepto los",
  "cadastro.termos": "Términos de Servicio",
  "cadastro.aceitoPolitica": "He leído y acepto la",
  ...
  "cadastro.erroTermos": "Debes aceptar los Términos de Servicio.",
  "cadastro.erroPolitica": "Debes aceptar la Política de Privacidad.",
